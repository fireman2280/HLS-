...
define_hls_config SobelFilter BASIC	--flatten_arrays=all
define_hls_config SobelFilter DPA   --dpopt_auto=op,expr
define_hls_config SobelFilter FLAT_UNROLL_ALL_FAST --flatten_arrays=all -post_elab_tcl {
...
define_sim_config V_UNROLL "SobelFilter RTL_V FLAT_UNROLL_ALL_FAST" -argv "$IN_FILE_NAME $OUT_FILE_NAME"
